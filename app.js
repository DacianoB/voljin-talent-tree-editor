...
function openTree(next,pristine){stateBase=pristine;state=next;editing=false;refunding=false;selected=null;connectFrom=null;$("edit-toggle").checked=false;history.replaceState(null,"",location.pathname+location.search);markDirty();render()}
function renderTabs(){
